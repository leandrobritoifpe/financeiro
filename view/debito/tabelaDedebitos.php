<?php
    ...
    if (!isset($_SESSION["dataInicial"]) || !isset($_SESSION["dataFinal"]) || $_SESSION["dataInicial"] == null || $_SESSION["dataFinal"] == null
            || !isset($_SESSION["credito"]) || $_SESSION["dataInicial"] == null) {
            ...
            <div class="row">
                ...
                <div class="col-md-9 well">
                    ...
                    <?php
                        ...
                        $dao = new DebitoDao();
                        $dao->abreBanco();
                        $listaDebito = $dao->listaDebitoReferente($_SESSION["dataInicial"], $_SESSION["dataFinal"], $_SESSION["ID"], $_SESSION["credito"]);                  
                    ?>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 73%;">
                            <div class="panel panel-primary" style="padding: 2%;">
                                <div class="panel-heading">
                                    ...
                                    <span class="glyphicon glyphicon-bookmark"></span> TABELA DE DÉBITOS</h3>
                                </div>
                                                ...
                                                <table class="table table-responsive table-striped" id="tabela" border='1'>
                                                    <thead style="text-align: center;">
                                                            <tr style='background-color: #0080FF;'>
                                                                ...
                                                                <th style='width: 20%;color : black' class="alinhaTexto">DESCRICAO</th>
                                                                <th style='width: 7%;color : black' class="alinhaTexto">VALOR</th>
                                                                <th style='width: 20%;color : black' class="alinhaTexto">CREDITO REFERENTE</th>
                                                                <th style='width: 5%;color : black' class="alinhaTexto">EDITAR</th>
                                                                <th style='width: 5%;color : black' class="alinhaTexto">REMOVER</th>
                                                                </tr>
                                                         </thead>
                                                         <?php                                                
                                                            for ($index = 0; $index < count($listaDebito); $index++) {
                                                                $debito = $listaDebito[$index];
                                                         ?>
                                                         <tr style="text-align: center">
                                                            <td class="alinhaTexto" style="color : black">
                                                                <?php echo @$debito->id?>
                                                            </td>
                                                            <td class="alinhaTexto" style="color : black">
                                                                <?php echo date('d/m/Y', strtotime(@$debito->data)) ?>
                                                            </td>
                                                            <td class="alinhaTexto" style="color : black">
                                                                <?php echo @$debito->descricao?>
                                                            </td>
                                                            <td class="alinhaTexto" style="color : black">
                                                                <?php echo "R$ ".number_format(@$debito->valor,2,",",".");?>
                                                            </td>
                                                            <td class="alinhaTexto" style="color : black">
                                                                <?php echo $debito->credito?>
                                                            </td>
                                                            <td class="alinhaTexto" style="color : black">
                                                                <a href="editarDebito.php?idDebito=<?php echo @$debito->id?>"                                                         
                                                                   class="glyphicon glyphicon-pencil" style="text-decoration: none;" 
                                                                   target="_blank" class="well well-sm" style="margin-bottom:5px;"
                                                                   /> 
                                                            </td>                          
                                                            <td>
                                                                <a href="../../controller/DebitoController.php?funcao=deletarDebito&idDebito=<?php echo @$debito->id?>
                                                                   &idCred=<?php echo @$debito->idCred?>&val=<?php echo @$debito->valor?>"
